...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/mask2former_beit.py', '../_base_/datasets/crackseg_896x896.py',
...
crop_size = (896, 896)
pretrained = '../../models/beit_large_patch16_224_pt22k_ft22k.pth'
load_from = '../../models/mask2former_beit_adapter_large_896_80k_cityscapes.pth.tar'
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(3840, 2160), ratio_range=(0.25, 1.0)),
